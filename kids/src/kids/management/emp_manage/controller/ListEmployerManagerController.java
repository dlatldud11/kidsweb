...
public class ListEmployerManagerController extends SuperClass {
	@Override
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = request.getContextPath() + "/Kids?command=empmList";
		
		Emp_ManageDao edao = new Emp_ManageDao();
		...
		List<Emp_Manage> lists = edao.SelectList(
		...
		String gotopage = "/emp_manage/empmList.jsp" ;
